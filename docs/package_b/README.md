# package_b — Documentation Index

> This folder is the team-curated reference for `package_b`.
...
Short paragraph: what is `package_b`, what problem does it solve, who owns it.
