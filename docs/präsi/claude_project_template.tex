...
\begin{frame}{Ein Regelsatz, zwei Assistenten}
  ...
  \begin{tikzpicture}[font=\scriptsize,every node/.style={align=center}]
    ...
    \node[rounded corners=2pt,fill=cardbg,draw=hhnblue,text width=4.0cm,minimum height=0.9cm]
      (claude) at (-4.2,0) {\textbf{\color{hhnblue}Claude Code}\\{\ttfamily\scriptsize\color{hhnblue}CLAUDE.md}};
    \node[rounded corners=2pt,fill=cardbg,draw=hhnpetrol,text width=4.0cm,minimum height=0.9cm]
      (copilot) at (4.2,0) {\textbf{\color{hhnpetrol}Copilot}\\{\ttfamily\scriptsize\color{hhnpetrol}copilot-instructions.md}};
